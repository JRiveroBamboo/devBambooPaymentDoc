    ...
    function onPageLoad() {
        ...
        if(!currentUrl.includes("/en/") && !currentUrl.includes("/es/") && !currentUrl.includes("/pt/")) {
            ...
            if(currentUrl.includes("/es/")) {
                language = "/es";
                languageCombo.innerHTML('<div class="content-bar-menu"></div>Español');
            } else if(currentUrl.includes("/pt/")) {
                language = "/pt";
                languageCombo.innerHTML('<div class="content-bar-menu"></div>Português');
            } else {
                languageCombo.innerHTML('<div class="content-bar-menu"></div>English');
            }
